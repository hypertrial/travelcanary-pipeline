...
docs-render:
	$(RUN_IN_REPO) "$(PYTHON)" -m pytest tests/test_docs_render.py -q -n 0

docs-test: docs-structure docs-render

docs-recipe-smoke:
	$(RUN_IN_REPO) "$(PYTHON)" scripts/check_docs_recipe_sql.py

docs-check: docs-build docs-test docs-recipe-smoke
